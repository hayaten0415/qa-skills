...
└── skills/                     # 各スキルは1階層(ネスト不可)
    ...
    ├── static-review/SKILL.md
    ├── white-box-coverage/SKILL.md
    └── qa-metrics/SKILL.md
```
...
| static-review | 全9特性(レビューは横断) | §3 | design |
| white-box-coverage | Functional Suitability(機能適合性) | §4.3 | design + impl |
| qa-metrics | 全9特性(モニタリングは横断) | §5.3 | design |
